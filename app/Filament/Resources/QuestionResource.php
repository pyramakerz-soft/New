...
class QuestionResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        ...
        //                 TagsInput::make('choices')->label('Letters')
        //                 ->afterStateUpdated(function (?array $state, \Livewire\Component $livewire, Forms\Get $get) {
        ...
        //             })
        // ->placeholder('Enter letters each on a new line')->columnSpanFull(),
    ...
    public static function getPages(): array
    {
        return [
            ...
            'view' => Pages\ViewQuestion::route('/{record}/view'),
        ];
    }
}