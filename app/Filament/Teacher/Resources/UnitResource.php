...
use App\Filament\Teacher\Resources\UnitResource\Pages;
use App\Filament\Teacher\Resources\UnitResource\RelationManagers;
        ...
        $unitNavigationItems = $lessons->map(function ($lessons) {
            return PageNavigationItem::make($lessons->name)
                ->url(function () use ($lessons) {
                    return URL("teacher/units/" . $lessons->id . "/lesson_view");
                })
            ;
        });
